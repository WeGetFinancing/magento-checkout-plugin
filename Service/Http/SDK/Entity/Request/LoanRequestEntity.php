...
use WeGetFinancing\Checkout\Service\Http\SDK\Entity\MoneyEntity;
...
class LoanRequestEntity extends AbstractRequestEntity
{
    ...
    /**
     * @Assert\Type(
     *     type = "WeGetFinancing\Checkout\Service\Http\SDK\Entity\MoneyEntity",
    ...
    /**
     * @Assert\Type(
     *     type = "WeGetFinancing\Checkout\Service\Http\SDK\Entity\Request\AddressEntity",
